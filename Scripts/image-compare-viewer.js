    ...
    var t = {
        ...
        8457: function (t, n, e) {
          ...
          t.exports = function (t) {
            ...
            var y,
              ...
              E = 0;
            if (!O || (this === p && a(O)))
              for (y = u(n), m = e ? new this(y) : p(y); y > E; E++)
                ((S = g ? h(n[E], E) : n[E]), f(m, E, S));
            else
              for (
                w = (x = l(n, O)).next, m = e ? new this() : [];
                !(b = o(w, x)).done;
                E++
              )
                ((S = g ? c(x, h, [b.value, E], !0) : b.value), f(m, E, S));
            return ((m.length = E), m);
          };
        },
        1318: function (t, n, e) {
        ...
        654: function (t, n, e) {
          ...
          t.exports = function (t, n, e, c, v, g, A) {
            ...
            if (
              (R &&
                (j = u(R.call(new t()))) !== Object.prototype &&
                j.next &&
                (i || u(j) === b || (f ? f(j, b) : a(j[w]) || p(j, w, _)),
                l(j, P, !0, !0),
                i && (h[P] = _)),
              y &&
                v == O &&
          ...
          var r = e(7293),
            ...
            h = (t.exports = function (t, n, e) {
              ("Symbol(" === String(n).slice(0, 7) &&
                ...
                e && e.setter && (n = "set " + n),
                (!i(t, "name") || (a && t.name !== n)) &&
                  d(t, "name", { value: n, configurable: !0 }),
                p &&
                  e &&
                  i(e, "arity") &&
                  t.length !== e.arity &&
              ...
              return (
                i(r, "source") ||
                  (r.source = v.join("string" == typeof n ? n : "")),
                t
              );
            });
        ...
        1574: function (t, n, e) {
          ...
          t.exports =
            ...
            c(function () {
              ...
              ? function (t, n) {
                  for (
                    var e = f(t), o = arguments.length, c = 1, d = s.f, p = u.f;
                    o > c;
                  )
                    for (
                      var h,
        ...
        6048: function (t, n, e) {
          ...
          n.f =
            r && !o
              ...
              : function (t, n) {
                  c(t);
                  for (var e, r = a(n), o = s(n), u = o.length, f = 0; u > f; )
                    i.f(t, (e = o[f++]), r[e]);
                  return t;
                };
        },
              ...
              ? function (t, n, e) {
                  if (
                    ...
                    r &&
                      ...
                      (e = {
                        configurable:
                          "configurable" in e ? e.configurable : r.configurable,
                        enumerable:
                          "enumerable" in e ? e.enumerable : r.enumerable,
                        writable: !1,
                      }));
                  }
                  return u(t, n, e);
          ...
          ((S || E || O || p || v) &&
            (y = function (t) {
              ...
              if (
                ...
                for (o.groups = u = l(null), c = 0; c < j.length; c++)
                  u[(f = j[c])[0]] = o[f[1]];
              return o;
            }),
            (t.exports = y));
            ...
            { target: "Array", proto: !0, forced: !v },
            {
              slice: function (t, n) {
                ...
                if (
                  ...
                  return p(d, m, b);
                for (
                  r = new (void 0 === e ? g : e)(y(b - m, 0)), l = 0;
                  m < b;
                  m++, l++
                )
                  m in d && f(r, l, d[m]);
        ...
        8862: function (t, n, e) {
          var r = e(2109),
            ...
            j = function (t, n, e) {
              var r = y(e, n - 1),
                o = y(e, n + 1);
              return (g(S, t) && !g(O, o)) || (g(O, t) && !g(S, r))
                ? "\\u" + x(m(t, 0), 16)
                : t;
            };
          h &&
        ...
        4032: function (t, n, e) {
          ...
          var r = e(2109),
            ...
            ot = function (t, n) {
              var e = (Z[t] = m(U));
              return (
                W(e, { type: G, tag: t, description: n }),
                s || (e.description = n),
                e
              );
            },
            ...
            st = function (t, n) {
              ...
              if (e !== Y || !l(Z, r) || l(tt, r)) {
                var o = $(e, r);
                return (
                  !o || !l(Z, r) || (l(e, N) && e[N][r]) || (o.enumerable = !0),
                  o
                );
              }
            },
          ...
          (u ||
            ((z = function () {
              ...
              var t =
                ...
                e = function (t) {
                  (this === Y && i(e, tt, t),
                    l(this, N) && l(this[N], n) && (this[N][n] = !1),
                    rt(this, n, y(1, t)));
                };
              return (
                s && et && rt(Y, n, { configurable: !0, set: e }),
                ot(n, t)
              );
            }),
        ...
        var o =
          ...
          l = function (t) {
            return i.some(function (n) {
              return !(
                !n.options.allowTouchMove || !n.options.allowTouchMove(t)
              );
            });
          },
          d = function (t) {
                    ...
                    : (function (t) {
                        if (void 0 === f) {
                          ...
                          if (n && e > 0) {
                            var r = parseInt(
                              window
                                .getComputedStyle(targetContent)
                                .getPropertyValue("padding-right"),
                              10,
                            );
                            ((f = targetContent.style.paddingRight),
                              (targetContent.style.paddingRight =
                                //r + e + "px"));
                                f));
                          }
                        }
                ...
                o
                  ? (function () {
                      if (void 0 !== u) {
                        ...
                        ((document.body.style.position = u.position),
                          (document.body.style.top = u.top),
                          (document.body.style.left = u.left),
                          window.scrollTo(n, t),
                          (u = void 0));
                      }
                    })()
                  : (void 0 !== f &&
                      ((targetContent.style.paddingRight = f), (f = void 0)),
                    void 0 !== s &&
              ...
              (e = [
                {
                  key: "mount",
                  value: function () {
                    (this.safariAgent && (this.settings.smoothing = !1),
                  ...
                  value: function () {
                    ...
                    (this.el.addEventListener("mousedown", function (n) {
                      ...
                      this.el.addEventListener("mouseenter", function () {
                        ...
                        var n = t.settings.addCircle
                          ? t.arrowCoordinates.circle
                          : t.arrowCoordinates.standard;
                    ...
                    var n = this.el.getBoundingClientRect(),
                      ...
                      r =
                        void 0 !== t.touches
                          ...
                          : t.clientY - n.top,
                      o = this.settings.verticalMode
                        ? (r / n.height) * 100
                        : (e / n.width) * 100;
                    o >= 0 &&
                      o <= 100 &&
                      (this.settings.verticalMode
                        ? (this.control.style.top = "calc("
                            .concat(o, "% - ")
                            .concat(this.slideWidth / 2, "px)"))
                        : (this.control.style.left = "calc("
                            .concat(o, "% - ")
                            .concat(this.slideWidth / 2, "px)")),
                      this.settings.fluidMode
                        ? this.settings.verticalMode
                          ? (this.wrapper.style.clipPath = "inset(0 0 ".concat(
                              100 - o,
                              "% 0)",
                            ))
                          : (this.wrapper.style.clipPath =
                              "inset(0 0 0 ".concat(o, "%)"))
                        : this.settings.verticalMode
                          ? (this.wrapper.style.height = "calc(".concat(
                              o,
                              "%)",
                            ))
                          : (this.wrapper.style.width = "calc(".concat(
                              100 - o,
                              "%)",
                            )));
                  },
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    (n.classList.add("icv__label", "icv__label-before", "keep"),
                      ...
                      this.settings.labelOptions.onHover &&
                        (n.classList.add("on-hover"),
                        e.classList.add("on-hover")),
                      this.settings.verticalMode &&
                        (n.classList.add("vertical"),
                        e.classList.add("vertical")),
                      (n.innerHTML =
                        this.settings.labelOptions.before || "Before"),
                      (e.innerHTML =
                        this.settings.labelOptions.after || "After"),
                      this.settings.showLabels &&
                        (this.el.appendChild(n), this.el.appendChild(e)),
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    for (var i = 0; i <= 1; i++) {
                      var c = document.createElement("div"),
                        a =
                          '<svg\n      height="15"\n      width="15"\n       style="\n       transform: \n       scale('
                            .concat(
                              this.settings.addCircle ? 0.7 : 1.5,
                              ")  \n       rotateZ(",
                            )
                            .concat(
                              0 === i
                            ...
                            .concat(
                              this.settings.addCircle ? 3 : 0,
                              '"\n       d="M4.5 1.9L10 7.65l-5.5 5.4"\n       />\n     </svg>',
                            );
                      ((c.innerHTML += a),
                        this.arrowAnimator.push(c),
                        r.appendChild(c));
                    }
                    var s = this.settings.addCircle
                    ...
                    (this.arrowAnimator.forEach(function (n, e) {
                      ...
                      (n.style.cssText = "\n    "
                        .concat(
                          this.settings.verticalMode ? "height" : "width ",
                          ": ",
                        )
                        .concat(this.slideWidth, "px;\n    ")
                        .concat(
                          this.settings.verticalMode ? "top" : "left ",
                          ": calc(",
                        )
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    for (var o = 0; o <= 1; o++) {
                      var i = r[o];
                      if (
                        (i.classList.add("icv__img"),
                        i.classList.add(0 === o ? "icv__img-a" : "icv__img-b"),
                        1 === o)
                      ) {
                        var c = document.createElement("div"),
                          a = r[1].src;
                    ...
                    if (this.settings.fluidMode) {
                      ...
                      (u.classList.add("icv__fluidwrapper"),
                        (u.style.cssText =
